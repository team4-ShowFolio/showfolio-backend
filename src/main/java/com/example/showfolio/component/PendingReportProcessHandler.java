...
/**
 * PENDING 상태의 신고 상태 처리를 위한 핸들러입니다.
 * */
@Component
@RequiredArgsConstructor
public class PendingReportProcessHandler implements ReportProcessHandler {
    ...
    public void handle(Report report, Long adminId, String reason) {
        reportProcessRepository.save(ReportProcess.of(report, adminId, ProcessStatus.PENDING, reason));
    }
}
